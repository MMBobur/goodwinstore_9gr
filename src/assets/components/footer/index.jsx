                                    ...
                                    <Container>
                                        <Grid sx={{display:'flex',gap:8,py:8}} columns={12}>
                                            ...
                                            <Grid xs={12} md={6} lg={3}>
                                                <Typography sx={{fontSize:'10px'}}>© COPYRIGHT 2020 GOODWINSTORE. ALL RIGHTS RESERVED.</Typography>
                                                <Typography sx={{fontSize:'10px'}}>TERMS & CONDITIONS PRIVACY POLICY</Typography>
                                            </Grid>
